    ...
    render() {
        return (
            ...
            <div className="Chat-contact">
                ...
                <span style={{ margin: 10 + 'px' }} className="left-content">{this.props.contactName}<br />Online</span>
                <div className="right-content">
                    <span style={{ margin: 10 + 'px' }} >Yesterday</span>
